...
// Source: github.com/shirasudon/go-chat/domain (interfaces: EventRepository)
...
func (m *MockEventRepository) Store(arg0 context.Context, arg1 ...domain.Event) ([]uint64, error) {
